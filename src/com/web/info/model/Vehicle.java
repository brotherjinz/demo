...
public class Vehicle {
	...
	private BigDecimal MIDPART_PICS_NUMBER; // 中间部张数 (NUMBER )
	private BigDecimal LOCK_VERSION; // 乐观锁定标识 (NUMBER )
	private BigDecimal FAULT_AUTO; // 自动识别故障数 (NUMBER )
	private BigDecimal FAULT_MANUL; // 人工识别故障数 (NUMBER )
	private BigDecimal CAR_AXIS_NUMBER; // 车辆轴数 (NUMBER(2) )
	private String GRAB_INFO; // 拍摄图像定位信息 (VARCHAR2(100) )
	private BigDecimal CMSPCAR_PICS_NUMBER; // 存储车辆侧部单通道相机采集的图像数量 (NUMBER(5) )
	private BigDecimal DMSPCAR_PICS_NUMBER; // 存储车辆底部单通道相机采集的图像数量 (NUMBER(5) )
	private String POS_AB_FLAG; // (VARCHAR2(1) )
	private BigDecimal MIDPARTCM_PICS_NUMBER; // 存储车中间部侧部单通道相机采集的图像数量,车辆种类为0时填写 (NUMBER(3) )
	private BigDecimal CMCTCAR_PICS_NUMBER; // 存储车辆侧面定检单通道相机采集的图像数量 (NUMBER(3) )
	private BigDecimal CMCAR_PICS_NUMBER; // 存储侧部线扫描相机单通道相机采集的图像数量 (NUMBER(3) )
	private BigDecimal DMCAR_PICS_NUMBER; // 存储底部线扫描相机单通道相机采集的图像数量 (NUMBER(3) )
	...
	public BigDecimal getMIDPART_PICS_NUMBER() {
		return MIDPART_PICS_NUMBER;
	}
	public void setMIDPART_PICS_NUMBER(BigDecimal mIDPART_PICS_NUMBER) {
	...
	public BigDecimal getFAULT_AUTO() {
		return FAULT_AUTO;
	}
	public void setFAULT_AUTO(BigDecimal fAULT_AUTO) {
		FAULT_AUTO = fAULT_AUTO;
	}
	public BigDecimal getFAULT_MANUL() {
		return FAULT_MANUL;
	}
	public void setFAULT_MANUL(BigDecimal fAULT_MANUL) {
		FAULT_MANUL = fAULT_MANUL;
	}
	public BigDecimal getCAR_AXIS_NUMBER() {
		return CAR_AXIS_NUMBER;
	}
	public void setCAR_AXIS_NUMBER(BigDecimal cAR_AXIS_NUMBER) {
	...
	public BigDecimal getCMSPCAR_PICS_NUMBER() {
		return CMSPCAR_PICS_NUMBER;
	}
	public void setCMSPCAR_PICS_NUMBER(BigDecimal cMSPCAR_PICS_NUMBER) {
		CMSPCAR_PICS_NUMBER = cMSPCAR_PICS_NUMBER;
	}
	public BigDecimal getDMSPCAR_PICS_NUMBER() {
		return DMSPCAR_PICS_NUMBER;
	}
	public void setDMSPCAR_PICS_NUMBER(BigDecimal dMSPCAR_PICS_NUMBER) {
	...
	public BigDecimal getMIDPARTCM_PICS_NUMBER() {
		return MIDPARTCM_PICS_NUMBER;
	}
	public void setMIDPARTCM_PICS_NUMBER(BigDecimal mIDPARTCM_PICS_NUMBER) {
		MIDPARTCM_PICS_NUMBER = mIDPARTCM_PICS_NUMBER;
	}
	public BigDecimal getCMCTCAR_PICS_NUMBER() {
		return CMCTCAR_PICS_NUMBER;
	}
	public void setCMCTCAR_PICS_NUMBER(BigDecimal cMCTCAR_PICS_NUMBER) {
		CMCTCAR_PICS_NUMBER = cMCTCAR_PICS_NUMBER;
	}
	public BigDecimal getCMCAR_PICS_NUMBER() {
		return CMCAR_PICS_NUMBER;
	}
	public void setCMCAR_PICS_NUMBER(BigDecimal cMCAR_PICS_NUMBER) {
		CMCAR_PICS_NUMBER = cMCAR_PICS_NUMBER;
	}
	public BigDecimal getDMCAR_PICS_NUMBER() {
		return DMCAR_PICS_NUMBER;
	}
	public void setDMCAR_PICS_NUMBER(BigDecimal dMCAR_PICS_NUMBER) {
